...
\begin{itemize}
  \item Overview of Dispersion
  \item Dispersion in qualitative (NO) data
  \item Dispersion in quantitative (IR) data
  \item Computational formula for variance
  \item Parameters v. statistics
\end{itemize}
