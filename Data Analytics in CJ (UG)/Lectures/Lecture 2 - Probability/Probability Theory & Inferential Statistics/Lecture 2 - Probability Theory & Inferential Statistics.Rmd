...
$$p(\text{not A})=p(\sim A)=p(A')=1-p(A)$$
\begin{center}
By definition, $p(A)+p(\sim A)=1$
\end{center}
...
$$p(2) = C^{3}_{2}p^{r}q^{n-r} = \frac{3!}{2!(3-2)!}0.52^{2}*0.48^{3-2} = `r (((3*2*1)/((2*1)*(1)))*(0.52^2)*(0.48^1))`$$
...
\begin{itemize}[<+->]
\item \alt<.>{$p(\text{A } \cup \text{ B}) = \text{ ??? } + \text{ ??? } = \frac{6384}{8549} = 0.747$}{$p(\text{B } \cup \text{ B}) = \frac{3168}{8549} + \frac{3216}{8549} = \frac{6384}{8549} = 0.747$}
