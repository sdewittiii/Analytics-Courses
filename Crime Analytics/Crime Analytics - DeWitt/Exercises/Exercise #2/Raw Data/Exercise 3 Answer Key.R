...
## IMPORT DATA
  nlsy97_raw <- read.csv("nlsy97raw.csv")
...
## CHANGE MISSING VALUES TO MISSING OR ZERO
  nlsy97$cigs_thirty99[nlsy97$cigs_thirty99==-4] <- 0
  nlsy97$marij_thirty99[nlsy97$marij_thirty99==-4] <- 0
  nlsy97$coke_thirty99[nlsy97$coke_thirty99==-4] <- 0
  nlsy97$destprop_num99[nlsy97$destprop_num99==-4] <- 0
  nlsy97$stllt50_num99[nlsy97$stllt50_num99==-4] <- 0
  nlsy97$stlgt50_num99[nlsy97$stlgt50_num99==-4] <- 0
  nlsy97$othprop_num99[nlsy97$othprop_num99==-4] <- 0
  nlsy97$selldrugs_num99[nlsy97$selldrugs_num99==-4] <- 0
  nlsy97$alc_thirty99[nlsy97$alc_thirty99==-4] <- 0
  nlsy97$empweeks_num98[nlsy97$empweeks_num98==-4] <- 0
  
  nlsy97$cigs_thirty99[nlsy97$cigs_thirty99==-1 |
                       nlsy97$cigs_thirty99==-2 |
                       nlsy97$cigs_thirty99==-3 |
                       nlsy97$cigs_thirty99==-5] <- NA
  nlsy97$marij_thirty99[nlsy97$marij_thirty99==-1 |
                        nlsy97$marij_thirty99==-2 |
                        nlsy97$marij_thirty99==-3 |
                        nlsy97$marij_thirty99==-5] <- NA
  nlsy97$coke_thirty99[nlsy97$coke_thirty99==-1 |
                       nlsy97$coke_thirty99==-2 |
                       nlsy97$coke_thirty99==-3 |
                       nlsy97$coke_thirty99==-5] <- NA
  nlsy97$destprop_num99[nlsy97$destprop_num99==-1 |
                        nlsy97$destprop_num99==-2 |
                        nlsy97$destprop_num99==-3 |
                        nlsy97$destprop_num99==-5] <- NA
  nlsy97$stllt50_num99[nlsy97$stllt50_num99==-1 |
                       nlsy97$stllt50_num99==-2 |
                       nlsy97$stllt50_num99==-3 |
                       nlsy97$stllt50_num99==-5] <- NA
  nlsy97$stlgt50_num99[nlsy97$stlgt50_num99==-1 |
                       nlsy97$stlgt50_num99==-2 |
                       nlsy97$stlgt50_num99==-3 |
                       nlsy97$stlgt50_num99==-5] <- NA
  nlsy97$othprop_num99[nlsy97$othprop_num99==-1 |
                       nlsy97$othprop_num99==-2 |
                       nlsy97$othprop_num99==-3 |
                       nlsy97$othprop_num99==-5] <- NA
  nlsy97$selldrugs_num99[nlsy97$selldrugs_num99==-1 |
                         nlsy97$selldrugs_num99==-2 |
                         nlsy97$selldrugs_num99==-3 |
                         nlsy97$selldrugs_num99==-5] <- NA
  nlsy97$alc_thirty99[nlsy97$alc_thirty99==-1 |
                      nlsy97$alc_thirty99==-2 |
                      nlsy97$alc_thirty99==-3 |
                      nlsy97$alc_thirty99==-5] <- NA
  nlsy97$empweeks_num98[nlsy97$empweeks_num98==-1 |
                        nlsy97$empweeks_num98==-2 |
                        nlsy97$empweeks_num98==-3 |
                        nlsy97$empweeks_num98==-5] <- NA
  nlsy97$int_year98[nlsy97$int_year98==-1 |
                    nlsy97$int_year98==-2 |
                    nlsy97$int_year98==-3 |
                    nlsy97$int_year98==-5] <- NA
  nlsy97$sex[nlsy97$sex==-1 |
             nlsy97$sex==-2 |
             nlsy97$sex==-3 |
             nlsy97$sex==-5] <- NA
  nlsy97$race[nlsy97$race==-1 |
              nlsy97$race==-2 |
              nlsy97$race==-3 |
              nlsy97$race==-5] <- NA
  nlsy97$birth_year[nlsy97$birth_year==-1 |
                    nlsy97$birth_year==-2 |
                    nlsy97$birth_year==-3 |
                    nlsy97$birth_year==-5] <- NA
  nlsy97$hh_struc98[nlsy97$hh_struc98==-1 |
                    nlsy97$hh_struc98==-2 |
                    nlsy97$hh_struc98==-3 |
                    nlsy97$hh_struc98==-5] <- NA
